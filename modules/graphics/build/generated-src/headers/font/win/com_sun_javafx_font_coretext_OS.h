...
/*
 * Class:     com_sun_javafx_font_coretext_OS
 * Method:    CGDataProviderCreateWithURL
 * Signature: (J)J
 */
JNIEXPORT jlong JNICALL Java_com_sun_javafx_font_coretext_OS_CGDataProviderCreateWithURL
  (JNIEnv *, jclass, jlong);

/*
 * Class:     com_sun_javafx_font_coretext_OS
 * Method:    CGFontCreateWithDataProvider
 * Signature: (J)J
 */
JNIEXPORT jlong JNICALL Java_com_sun_javafx_font_coretext_OS_CGFontCreateWithDataProvider
  (JNIEnv *, jclass, jlong);
...
/*
 * Class:     com_sun_javafx_font_coretext_OS
 * Method:    CTFontCreateWithGraphicsFont
 * Signature: (JDLcom/sun/javafx/font/coretext/CGAffineTransform;J)J
 */
JNIEXPORT jlong JNICALL Java_com_sun_javafx_font_coretext_OS_CTFontCreateWithGraphicsFont
  (JNIEnv *, jclass, jlong, jdouble, jobject, jlong);
